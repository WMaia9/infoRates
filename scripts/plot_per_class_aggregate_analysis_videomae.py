...
plt.title('Top 20 Classes by Mean Accuracy Across All Configurations (ViViT)', fontsize=16)
plt.ylabel('Mean Accuracy', fontsize=14)
plt.xlabel('Class', fontsize=14)
plt.xticks(rotation=45, ha='right')
plt.grid(axis='y', alpha=0.3)
plt.tight_layout()
plt.savefig("data/UCF101_data/results/vivit/per_class_aggregate_analysis.png", dpi=300)
plt.close()
print("Saved: data/UCF101_data/results/vivit/per_class_aggregate_analysis.png")